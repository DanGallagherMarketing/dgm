...
const CaseStudy = ({ data }) => {
  return (
    ...
    >
      <SEO title="Bennison Brown Mortgages" />

      <section className={classes.Section}>
        <h2>The Situation</h2>
        <p>
          Bennison Brown are a London mortgage broker. Their service is centred
          around finding the best possible mortgage deals available for their
          customers, and making their mortgage journey as stress-free as
          possible.
        </p>
        <p>
        ...
        <p>
          The campaign averaged a Click-Through rate of 1.40%, a conversion rate
          of 2.04% and a Cost Per Conversion of £27.31 and a Cost Per Click of
          £0.56
        </p>
      </section>
      ...
      <section className={classes.Section}>
        ...
        <p>
          {" "}
          Combined with a poor negative keyword list, their ads were showing for
          a lot of search terms that were either completely irrelevant, or
        ...
        <p>
          ...
          of using a mortgage broker, but were instead calling to ask for advice
          on the current best rates on the market. Essentially, although they
          were getting phone call (Marketing Qualified Leads), a very small
          portion of those became actual customers (Sales Qualified Leads).
        </p>
      </section>
      <section className={classes.Section}>
        <h2>The Process</h2>
